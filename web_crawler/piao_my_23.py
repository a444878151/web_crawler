...
sys.path.append('/app/bin/script/')
LoggerObj = _Logger(log_project='piao_my_23')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            ...
            tr = response.text
            LOGGER.info('get result from remote: {}'.format(tr.encode("UTF-8")))
        ...
        count = count + 1
        time.sleep(5)
        LOGGER.info('have try times: {}'.format(str(count)))
